...
const Cart = () => {
  ...
  return (
    <div className={`min-h-screen pb-32 transition-colors ${
          ...
          >
            <div className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-sm text-fresh-green line-clamp-2 mb-1">
                  {item.name}
                </h3>
                <p className="text-xs text-fresh-green/50 font-semibold mb-2">
                  {item.weight}
                </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-base text-fresh-green">₹{item.price}</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center bg-leaf rounded-lg">
                      <button
                        onClick={() => removeFromCart(item.id)}
                        className="p-1.5 bg-white text-leaf rounded-l-lg hover:bg-fresh-green/10 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 bg-white text-leaf rounded-r-lg hover:bg-fresh-green/10 transition-colors"
                      >
      ...
      {/* Bill Details */}
      <div className="mx-4 mb-4 bg-white rounded-2xl p-4 shadow-sm border border-fresh-green/10">
        <h3 className="font-black text-fresh-green mb-3">Bill Details</h3>
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span className="text-fresh-green/60">Items total</span>
          ...
          <div className="border-t border-fresh-green/10 pt-2 mt-2">
            <div className="flex justify-between">
              <span className="font-black text-fresh-green">Grand Total</span>
      ...
      <div className="fixed bottom-16 left-0 right-0 z-40 px-4">
        <div className="max-w-[450px] mx-auto">
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-fresh-green to-leaf text-white py-4 rounded-xl font-black text-base shadow-2xl flex items-center justify-between px-6"
          >
