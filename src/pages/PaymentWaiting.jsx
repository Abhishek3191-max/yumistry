  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0fdf4] via-white to-[#ecfccb] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 bg-white/90 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white max-w-md w-full text-center"
      >
        {/* Animated Loader */}
        <motion.div
          animate={{ rotate: 360 }}
        ...
        >
          <h1 className="text-2xl font-black text-fresh-green mb-2">Processing Payment</h1>
          <p className="text-fresh-green/60 font-medium mb-6">
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="flex items-center gap-3 p-3 bg-leaf/5 rounded-xl"
            >
              <div className="bg-white rounded-lg p-2">
                <step.icon size={20} className="text-leaf" />
              </div>
              <span className="text-sm font-semibold text-fresh-green">{step.text}</span>
            </motion.div>
          ))}
        </motion.div>
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-2 pt-4 border-t border-fresh-green/10"
        >
      ...
      <motion.p
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="relative z-10 text-center text-sm text-fresh-green/50 font-medium mt-6"
      >
